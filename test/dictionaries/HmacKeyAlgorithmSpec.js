...
describe('HmacKeyAlgorithm', () => {
  describe('dictionaries getter', () => {
    it('should return an array', () => {
      HmacKeyAlgorithm.dictionaries.should.eql([
        KeyAlgorithm,
        HmacKeyAlgorithm
      ])
    })
  ...
  describe('members getter', () => {
    it('should return an object', () => {
      HmacKeyAlgorithm.members.should.eql({})
    })
  })
  ...
  describe('sign', () => {
    ...
    it('should return an ArrayBuffer', () => {
      let hmac = new HmacKeyAlgorithm(alg)
  ...
  describe('generateKey', () => {
    ...
    it('should set key algorithm', () => {
      key.algorithm.should.be.instanceof(HmacKeyAlgorithm)
    })
  ...
  describe('importKey', () => {
    ...
    it('should set key algorithm', () => {
      hmac.importKey('raw', rawHmacKey, alg, true, ['sign', 'verify'])
        .algorithm.should.be.instanceof(HmacKeyAlgorithm)
    })
